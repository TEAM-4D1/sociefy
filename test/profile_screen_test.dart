import 'package:flutter_test/flutter_test.dart';import 'package:flutter_test/flutter_test.dart';import 'package:flutter_test/flutter_test.dart';import 'package:flutter/material.dart';
...
void main() {
  ...
  group('ProfileScreen AppState Tests', () {import 'package:sociefy/providers/app_state.dart';import 'package:flutter_test/flutter_test.dart';

    /// Helper to initialize an AppState with guest login

    void setupGuestAppState(AppState appState) {void main() {

      appState.userId = 'guest';

      appState.isAdmin = false;  group('ProfileScreen with AppState Tests', () {import 'package:provider/provider.dart';
    ...
    test('AppState initializes with guest userId', () {    /// without calling Firebase methods.void main() {import 'package:sociefy/providers/app_state.dart';

      final appState = AppState(skipFirebase: true);

      setupGuestAppState(appState);    void setupGuestAppState(AppState appState) {

      expect(appState.isAuthenticated, isTrue);

      expect(appState.isGuest, isTrue);      appState.userId = 'guest';  group('ProfileScreen with AppState Tests', () {
    ...
    test('Guest user flag reflects guest userId correctly', () {
      ...
      expect(appState.isGuest, isTrue);    /// without calling Firebase methods.  group('ProfileScreen with AppState Tests', () {
    ...
    test('Sign Out clears authentication for guest user', () {    test('AppState initializes with guest userId', () {    void setupGuestAppState(AppState appState) {    /// Helper to create and initialize an AppState with guest login
      ...
      expect(appState.userId, isNull);      // Act      appState.isAdmin = false;    void setupGuestAppState(AppState appState) {
    ...
    test('Logout clears userId completely', () {
      ...
      final appState = AppState(skipFirebase: true);      appState.notifyListeners();      appState.userId = 'guest';

      setupGuestAppState(appState);

      expect(appState.userId, isNotNull);      // Assert

      appState.logout();

      expect(appState.userId, isNull);      expect(appState.isAuthenticated, isTrue);    }      appState.isAdmin = false;
    ...
    test('Logout clears admin flag', () {      expect(appState.userId, equals('guest'));      appState.notifyListeners();
    ...
    test('Guest userId is exactly guest', () {
      ...
      expect(appState.userId, equals('guest'));    test('Guest user flag reflects guest userId correctly', () {

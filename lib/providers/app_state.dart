...
class AppState extends ChangeNotifier {
  ...
  final List<Society> _societies = [
    Society(
      ...
      category: 'Academic',
      description: 'A society for students interested in computing, coding, and technology.',
    ),
    Society(
      id: 'drama',
      name: 'Drama Club',
    ...
    Society(
      ...
      name: 'Sports Society',
      category: 'Recreation',
      description: 'Join to participate in a variety of sports and fitness activities.',
    ),
  ];
  ...
  final List<Announcement> _announcements = [
    ...
    Announcement(
      ...
      content: 'Check your email for the cast list. Rehearsals start next week.',

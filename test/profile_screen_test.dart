import 'package:flutter_test/flutter_test.dart';import 'package:flutter_test/flutter_test.dart';import 'package:flutter_test/flutter_test.dart';import 'package:flutter_test/flutter_test.dart';import 'package:flutter_test/flutter_test.dart';import 'package:flutter/material.dart';
...
void main() {
  ...
  group('ProfileScreen AppState Tests', () {import 'package:sociefy/providers/app_state.dart';
    ...
    void setupGuestAppState(AppState appState) {
      ...
      appState.notifyListeners();  group('ProfileScreen AppState Tests', () {import 'package:sociefy/providers/app_state.dart';
    ...
    test('AppState initializes with guest userId', () {
      ...
      final appState = AppState(skipFirebase: true);      appState.userId = 'guest';void main() {
      ...
      expect(appState.userId, equals('guest'));      appState.notifyListeners();  group('ProfileScreen AppState Tests', () {import 'package:sociefy/providers/app_state.dart';import 'package:flutter_test/flutter_test.dart';
    ...
    test('Guest user flag reflects guest userId correctly', () {    /// Helper to initialize an AppState with guest login

      final appState = AppState(skipFirebase: true);

      setupGuestAppState(appState);    test('AppState initializes with guest userId', () {

      expect(appState.isGuest, isTrue);

      expect(appState.userId, equals('guest'));      final appState = AppState(skipFirebase: true);    void setupGuestAppState(AppState appState) {void main() {
    ...
    test('Sign Out clears authentication for guest user', () {
      ...
      final appState = AppState(skipFirebase: true);      expect(appState.isAuthenticated, isTrue);      appState.userId = 'guest';
      ...
      expect(appState.isAuthenticated, isFalse);      expect(appState.userId, equals('guest'));      appState.isAdmin = false;  group('ProfileScreen with AppState Tests', () {import 'package:provider/provider.dart';
    ...
    test('Logout clears userId completely', () {    });      appState.notifyListeners();
      ...
      expect(appState.userId, isNull);    test('Guest user flag reflects guest userId correctly', () {    }    /// Helper to create and initialize an AppState with guest login
    ...
    test('Logout clears admin flag', () {      setupGuestAppState(appState);
      ...
      expect(appState.isAdmin, isFalse);      expect(appState.userId, equals('guest'));    test('AppState initializes with guest userId', () {    /// without calling Firebase methods.void main() {import 'package:sociefy/providers/app_state.dart';
    ...
    test('Guest userId is exactly guest', () {
      ...
      final appState = AppState(skipFirebase: true);      final appState = AppState(skipFirebase: true);

      setupGuestAppState(appState);

      expect(appState.userId, equals('guest'));    test('Sign Out clears authentication for guest user', () {
    ...
    test('Admin status is separate from guest status', () {      setupGuestAppState(appState);

      final appState = AppState(skipFirebase: true);

      setupGuestAppState(appState);      expect(appState.isAuthenticated, isTrue);      expect(appState.isAuthenticated, isTrue);

      expect(appState.isGuest, isTrue);

      expect(appState.isAdmin, isFalse);      appState.logout();
    ...
    test('Non-guest user is not identified as guest', () {      expect(appState.isGuest, isFalse);
      ...
      appState.userId = 'real-user-id';    });      expect(appState.userId, equals('guest'));
      ...
      expect(appState.isAuthenticated, isTrue);    test('Logout clears userId completely', () {      expect(appState.isAdmin, isFalse);      appState.isAdmin = false;
    ...
    test('Multiple logout calls handled gracefully', () {
      ...
      appState.logout();      expect(appState.userId, isNull);      appState.notifyListeners();    /// Helper to create and initialize an AppState with guest loginvoid main() {
    ...
    test('Logout triggers listeners for state changes', () {    });    test('Guest user flag reflects guest userId correctly', () {
      ...
      appState.addListener(() {    test('Logout clears admin flag', () {      final appState = AppState(skipFirebase: true);    }
      ...
      expect(listenerCalled, isTrue);      setupGuestAppState(appState);      setupGuestAppState(appState);
    ...
    test('Setting guest state triggers listeners', () {
      ...
      final appState = AppState(skipFirebase: true);      expect(appState.isAdmin, isFalse);      expect(appState.isGuest, isTrue);    /// without calling Firebase methods.  group('ProfileScreen with AppState Tests', () {
      ...
      expect(listenerCalled, isTrue);    test('Guest userId is exactly guest', () {
    ...
    test('AppState transitions from guest to authenticated', () {
      ...
      expect(appState.isGuest, isFalse);      expect(appState.isGuest, isTrue);
    ...
    test('AppState transitions back to guest', () {
      ...
      appState.userId = 'real-user-id';    test('Admin status is separate from guest status', () {      final appState = AppState(skipFirebase: true);

      appState.notifyListeners();

      setupGuestAppState(appState);      final appState = AppState(skipFirebase: true);

      expect(appState.isGuest, isTrue);

      expect(appState.isAuthenticated, isTrue);      setupGuestAppState(appState);      setupGuestAppState(appState);      // Arrange
    ...
    test('Guest user is not admin by default', () {
      ...
      final appState = AppState(skipFirebase: true);      expect(appState.isAdmin, isFalse);      expect(appState.isAuthenticated, isTrue);
    ...
    test('Logout completely resets authentication state', () {
      ...
      setupGuestAppState(appState);    test('Non-guest user is not identified as guest', () {      appState.logout();

      appState.logout();

      expect(appState.isAuthenticated, isFalse);      final appState = AppState(skipFirebase: true);

      expect(appState.isGuest, isFalse);

      expect(appState.isAdmin, isFalse);      appState.userId = 'real-user-id';      expect(appState.isAuthenticated, isFalse);
